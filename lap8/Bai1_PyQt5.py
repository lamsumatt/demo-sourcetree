...
class YesNoApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Yes No App')
    ...
    def show_yes_message(self):
        QMessageBox.information(self, 'Thông báo', 'Bạn đã nhấp vào nút "Có"')

    def show_no_message(self):
        QMessageBox.information(self, 'Thông báo', 'Bạn đã nhấp vào nút "Không"')
